...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->Username   = 'mamatapoudel067@gmail.com';             // Your Gmail address
        $mail->Password   = 'spge gzto nsxu vpoq';               // Use app password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;           // Enable implicit TLS encryption
        $mail->Port       = 465;                                    // TCP port

        // Recipients
        $mail->setFrom($email, $name);
        $mail->addAddress('mamatapoudel777@gmail.com', 'Receiver');
